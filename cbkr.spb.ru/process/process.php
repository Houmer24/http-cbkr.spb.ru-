...
MAIL_FROM = 'office@cbkr.spb.ru', // от какого email будет отправляться письмо
MAIL_FROM_NAME = 'http://cbkr.spb.ru/', // от какого имени будет отправляться письмо
MAIL_SUBJECT = 'Сообщение с сайта cbkr.spb.ru', // тема письма
MAIL_ADDRESS = 'office@cbkr.spb.ru', // кому необходимо отправить письмо
...
MAIL_SMTP_USERNAME = 'office@cbkr.spb.ru', // SMTP-пользователь
